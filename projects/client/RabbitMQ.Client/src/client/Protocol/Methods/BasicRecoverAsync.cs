...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public struct BasicRecoverAsync : IMethod, IBasicRecoverAsync
    {
        ...
        public bool Requeue { get { return m_requeue; } }
        ...
        public ushort ProtocolMethodId { get { return 100; } }
        public string ProtocolMethodName { get { return "basic.recover-async"; } }
        ...
        {
            NetworkBinaryWriter1.WriteByte(writer, Convert.ToByte(m_requeue), out int written1);
            written = written1;
        }
