...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public class BasicConsume : IMethod, IBasicConsume
    {
        ...
        public void WriteArgumentsTo(ref Span<byte> writer, out int written)
        {
            ...
            NetworkBinaryWriter1.WriteShortString(ref writer, m_consumerTag, out int written3);
            NetworkBinaryWriter1.WriteByte(ref writer, (byte)m_settings, out int written4);
