...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public struct ConnectionBlocked : IMethod, IConnectionBlocked
    {
        ...
        public string ProtocolMethodName { get { return "connection.blocked"; } }
        ...
        {
            NetworkBinaryWriter1.WriteShortString(ref writer, m_reason, out int written1);
            written = written1;
        }
