...
namespace RabbitMQ.Client.Framing.Impl
{
    ...
    public struct BasicAck : IMethod, IBasicAck
    {
        ...
        public ushort ProtocolMethodId { get { return 80; } }
        public string ProtocolMethodName { get { return "basic.ack"; } }
        ...
        public void WriteArgumentsTo(Span<byte> writer, out int written)
        {
            ...
            NetworkBinaryWriter1.WriteByte(writer.Slice(written1), Convert.ToByte(m_multiple), out int written2);
