...
namespace RabbitMQ.Client.Unit
{
    ...
    public class TestFieldTableFormattingGeneric //: WireFormattingFixture
    {
        ...
        {
            ArraySegmentStream writerStream = new ArraySegmentStream();
            ...
            array.Add(1234);
            t["fieldarray"] = array;
            w.WriteTable(t, out int written);

            ArraySegmentSequence readerSequence = new ArraySegmentSequence(writerStream.Data);
