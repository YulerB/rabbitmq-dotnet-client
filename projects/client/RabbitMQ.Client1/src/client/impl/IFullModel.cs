...
using RabbitMQ1.Client.Apigen.Attributes;
...
namespace RabbitMQ1.Client.Impl
{
    ...
    ///
    ///<see cref="RabbitMQ1.Client.Impl.ModelBase"/>
    ///<see cref="RabbitMQ1.Client.Framing.Impl.Model"/>
    public interface IFullModel : IModel
    {
        ...
        void HandleConnectionOpenOk([AmqpFieldMapping("RabbitMQ1.Client.Framing", "reserved1")] string knownHosts);
        ...
        void _Private_ChannelOpen([AmqpFieldMapping("RabbitMQ1.Client.Framing",
        ...
        void _Private_ConnectionOpen(string virtualHost,
            [AmqpFieldMapping("RabbitMQ1.Client.Framing", "reserved1")] string capabilities,
            [AmqpFieldMapping("RabbitMQ1.Client.Framing", "reserved2")] bool insist);
...
namespace RabbitMQ1.Client.Apigen.Attributes
{
