...
using RabbitMQ1.Client.Exceptions;
using RabbitMQ1.Client.Impl;
...
namespace RabbitMQ1.Client.Framing.Impl
{
    public class Connection : IConnection
    {
        ...
        public static IDictionary<string, object> DefaultClientProperties()
        {
            ...
            table["product"] = Encoding.UTF8.GetBytes("RabbitMQ1");
...
entry.ToString());
        ...
        public void HeartbeatWriteTimerCallback(object state)
        {
            ...
            catch (Exception)
            {
                ...
                // peer unavailability. See RabbitMQ1/RabbitMQ1-dotnet-client#638 for details.
            }
        ...
        private void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                {
                    // ignored, see RabbitMQ1/RabbitMQ1-dotnet-client#133
                }
                finally
                {
