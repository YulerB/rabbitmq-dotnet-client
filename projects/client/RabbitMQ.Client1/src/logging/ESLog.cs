...
namespace RabbitMQ1.Client
{
    public static class ESLog
    {
        ...
        {
            Logging.RabbitMQ1ClientEventSource.Log.Info(message);
        }
        ...
        {
            Logging.RabbitMQ1ClientEventSource.Log.Warn(message);
        }
        ...
        {
            Logging.RabbitMQ1ClientEventSource.Log.Error(message, ex);
        }
